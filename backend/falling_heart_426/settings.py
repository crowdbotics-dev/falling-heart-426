"""
Django settings for falling_heart_426 project.
...
ROOT_URLCONF = 'falling_heart_426.urls'
...
WSGI_APPLICATION = 'falling_heart_426.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_heart_426 API",
    "DESCRIPTION": "API documentation for falling_heart_426 App",
    "VERSION": "v1",
}
